...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--pre-summary",
        default="results/stages/01_qc/qc_pre/pre_qc_summary.csv",
    )
    parser.add_argument(
        "--pre-per-cell",
        default="results/stages/01_qc/qc_pre/pre_qc_per_cell.parquet",
    )
    parser.add_argument("--out-dir", default="results/stages/01_qc/qc_post")
