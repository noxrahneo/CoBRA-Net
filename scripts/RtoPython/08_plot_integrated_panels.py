...
Input:
- results/stages/03_integration/integrated/
    <Condition>/<Condition>_integrated.h5ad

Output:
- results/stages/03_integration/integrated/panels/umap_panel_<color_key>.png
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-dir",
        default="results/stages/03_integration/integrated/panels",
